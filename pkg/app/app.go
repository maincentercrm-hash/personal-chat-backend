...
func SetupApp(container *di.Container) *fiber.App {
	...
	routes.SetupRoutes(
		...
		container.BusinessAccountHandler,
		container.BusinessFollowHandler,
		container.BusinessAdminHandler,
		...
		container.CustomerProfileHandler,
		container.TagHandler,
		container.UserTagHandler,
		container.AnalyticsHandler,
		container.StickerHandler,
		container.BusinessWelcomeMessageHandler,
		container.BroadcastHandler,
		container.BroadcastDeliveryHandler,
